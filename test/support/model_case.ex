defmodule SneakerfansPhoenix.ModelCase do
  @moduledoc """
  ...
  using do
    quote do
      ...
      import Ecto.Query
      import SneakerfansPhoenix.ModelCase
    end
  end
  ...
  def errors_on(struct, data) do
    ...
    |> Ecto.Changeset.traverse_errors(&SneakerfansPhoenix.ErrorHelpers.translate_error/1)
