defmodule SneakerfansElixir.ModelCase do
  @moduledoc """
  ...
  using do
    quote do
      ...
      import Ecto.Query
      import SneakerfansElixir.ModelCase
    end
  end
  ...
  def errors_on(struct, data) do
    ...
    |> Ecto.Changeset.traverse_errors(&SneakerfansElixir.ErrorHelpers.translate_error/1)
